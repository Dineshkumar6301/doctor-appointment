...
urlpatterns = [
    ...
    path('doctor/services/', views.add_listing, name='add_listing'),
     path('doctors/add-appointment/', views.add_appointment, name='add_appointment'),
    path('doctor/schedule-timing/', views.schedule_timing_view, name='schedule_timing'),
    path('doctor/change-password/', views.change_password, name='change_password'),
    path('doctors/<slug:slug>/', views.doctor_list_view, name='doctor_list'),
    path('doctors/', views.doctor_list_view, name='doctor_list'),
    path('dr/<int:id>-<slug:slug>/book/', views.book_appointment, name='book_appointment'),
    path('doctor/<slug:slug>/', views.doctor_detail_view, name='doctor_detail'),
    ...
    path('dr/<int:id>-<slug:slug>/reviews/', views.doctor_reviews, name='doctor_reviews'),
    
    path('patient/profile/', views.profile, name='profile'),
    path('patient/change-password2/', views.change_password2, name='change_password2'),
    ...
    path('clinic/<int:id>-<slug:slug>/', views.clinic, name='clinic'),
